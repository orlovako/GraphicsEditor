...
{
    /// <summary>
    /// Сводное описание для СhangePenColorTests
    /// </summary>
    [TestClass]
    public class СhangePenColorTests
    {       

        [TestMethod]
        public void RedoTest()
        {
            var deleteFigure = Mock.Create<СhangePenColor>(() => new СhangePenColor(new List<Figure>(), new Color()));
            deleteFigure.Redo();
